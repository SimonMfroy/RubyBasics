...
#puts handleTwitter.count

#######################################
#exo 2 :
numberHandle = handleTwitter.count
numberChaInit = 100
minNumberCha = 0
numberHandle.times do |i|
	numberChaTwit = handleTwitter[i].length
	if numberChaTwit < numberChaInit
		numberChaInit = numberChaTwit
		minNumberCha = handleTwitter[i]
	end
end
puts minNumberCha
nbMinCha = 0
numberHandle.times do |i|
	numberChaTwitBis = handleTwitter[i].length
	if numberChaTwitBis == 6
		nbMinCha = nbMinCha + 1
	end
end
#puts nbMinCha
...
nbUpcase = 0	
numberHandle.times do |i|
	if handleTwitter[i][1] === handleTwitter[i][1].capitalize
		nbUpcase = nbUpcase +1
	end
end
#puts nbUpcase
...
#######################################
#exo 4:
#puts handleTwitter.sort {|a, b| a.length <=> b.length}

#######################################
#exo 5:
#puts handleTwitter.index("@epenser")

#######################################
#exo 6:
def functionTest(n, handleTwitter)
	nbMinCha = 0
	handleTwitter.count.times do |i|
		numberChaTwitBis = handleTwitter[i].length
		if numberChaTwitBis == n
			nbMinCha = nbMinCha + 1
		end
	end
#puts nbMinCha
...
#######################################
#exo 7:
handleTwitter.max {|a, b| a.length <=> b.length}.length.times do |i|
	i+=1
	functionTest(i, handleTwitter)
end